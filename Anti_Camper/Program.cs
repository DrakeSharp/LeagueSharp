...
namespace Anti_Camper
{
    internal class Program
    {
        ...
        private static void OnDraw(EventArgs args)
        {
            ...
            if (test > Game.Time) Drawing.DrawText(textx, texty, Color.Red, "Enemy detected");
    ...
    if ((int)(Game.Time * 2) % 2 == 1) Drawing.DrawText(textx, texty, Color.Red, "Enemy detected");
            Drawing.DrawCircle(dangers.pos, 1400, Color.Crimson);
            delay++;
            if (sound.GetValue<Boolean>()&&delay==10)ThreadPool.QueueUserWorkItem(ignoredState =>
            {
